  ...
  <div v-show="showFlag" class="food" transition="move" v-el:food>
    <div class="food-content">
      <div class="image-header">
        <img :src="food.image">
        <div class="back" @click="showFlag=false"><i class="icon-arrow_lift"></i></div>
      </div>
      <div class="content">
        ...
        <div class="buy" @click="addFirst($event)" v-else transition="fade">加入购物车</div>
      </div>
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    events: {
      'ratingype.select'(type) {
        this.selectType = type;
        this.$nextTick(() => {
          this.scroll.refresh();
        });
      },
      'content.toggled'(onlyContent) {
    ...
    .content
      ...
      .buy
        ...
        &.transition-fade
          ...
          opacity: 1
        &.transition-enter, &.transition-move
          opacity: 0
    .info
      padding: 18px
      .title
